            ...
            {showFilters && (
              <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="bi-location" className="block text-sm font-medium text-gray-700 mb-2">
                      Location
                    </label>
                  ...
                  <div>
                    <label htmlFor="bi-type" className="block text-sm font-medium text-gray-700 mb-2">
                      Type
                    </label>
                    <select
                      id="bi-type"
