                    ...
                    {activeTab === ('my-internships' as any) && (
                      <div className="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div className="text-center py-12 bg-gray-50 rounded-lg">
                          <p className="text-gray-600">To see your posted internships, please check the 'Browse Internships' page for now.</p>
                          <Link to="/browse" className="text-blue-600 font-medium hover:underline mt-2 inline-block">Go to Browse Page</Link>
                        </div>
                      </div>
                    )}
